"""
Sampling of the Dirichlet Gaussian free field on the unit square.
...
def gff(N, show2d=False, show3d=False):
    """
    Sample a Dirichlet Gaussian free field on an (N+1)x(N+1) of the unit square
    """
    ...
    # Rescale GFF to have log covariance, no factors of pi
